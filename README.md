...
Example Usage:
    ...
    $ heroku create --stack cedar --buildpack https://github.com/moovweb/heroku-buildpack-ruby
...
Example Usage:
    ...
    $ heroku create --stack cedar --buildpack https://github.com/moovweb/heroku-buildpack-ruby.git
